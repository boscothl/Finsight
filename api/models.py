...
class GeneratedReport(models.Model):
    ...
    title = models.CharField(max_length=255, blank=True, null=True, help_text="AI derived title for this report")
    file_url = models.URLField(max_length=1024)
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return self.title or f"Report {self.id} generated by {self.user}"
